...
@connect(
  state => ({user: state.auth.user, donation: state.donation}),
...
export default class GotVeggies extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (this.props.donation.confirmingDonation && nextProps.donation.donationConfirmed) {
      this.context.router.transitionTo('/donation-confirmed');
    }
  }
