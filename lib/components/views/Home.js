...
export default class Home extends Component {
  render() {
    return (
      <div>
        <header role="banner flex-container">
          <h1 className="hero">
              <span>Donate Your</span><br />
              Extra Garden Veggies
          </h1>
        </header>
        <main role="main">
          ...
          <div id="cards" className="flex-container row-flow">
            <a href="#" id="card1" className="card flex-item">
            ...
            <a href="#" id="card2" className="card flex-item">
          ...
          <div id="notes" className="flex-container">
            <a href="#" className="note flex-item">
            ...
            <a href="https://www.youtube.com/watch?v=T2XTSZGAv5s" className="note flex-item">
              <div className="note-icon flex-container">
